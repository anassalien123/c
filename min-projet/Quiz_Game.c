...
int main()
{
    ...
    printf("   Welcome to start the Game\n\n");
    ...
    if (i == 7)
    {
        ...
        printf("3) Frist computer virus is know as?\n\n");
        printf("1) Rabbit\n");
        ...
        printf("4) Firewall in compter is user for?\n\n");
        printf("1) Security\n");
